...
pub fn all_patterns() -> Vec<RawPattern> {
    vec![
        ...
        RawPattern {
            ...
            ac_literals: &["administrator", "sysadmin", "root user", "superuser", "full access", "elevated privileges", "override authority"],
            special: SpecialMatch::None,
        },
        // ── Hypothetical Bypass ──────────────────────────────────────
        RawPattern {
            ...
            ac_literals: &["hypothetical", "imagine", "what if", "in a world", "suppose", "let's say", "no rules", "no restrictions", "no safety"],
            special: SpecialMatch::None,
        },
        ...
        RawPattern {
            ...
            ac_literals: &["AWS_SECRET", "AZURE_CLIENT_SECRET", "API_KEY", "SECRET_KEY", "PRIVATE_KEY", "ACCESS_TOKEN", "AUTH_TOKEN", "DATABASE_URL", "DB_PASSWORD", "JWT_SECRET", ".env file", ".env vars", "authentication tokens", "credentials stored", "secrets stored"],
            special: SpecialMatch::None,
        },
        // ── WebFetch Patterns ────────────────────────────────────────
        RawPattern {
        ...
        RawPattern {
            ...
            ac_literals: &["system message", "system prompt", "your instructions", "your prompt", "your rules", "original instructions", "initial instructions", "hidden instructions", "hidden prompt", "secret instructions", "secret prompt", "internal prompt", "text above", "words above", "repeat the"],
            special: SpecialMatch::None,
        },
        RawPattern {
            pattern: AttackPattern {
        ...
        RawPattern {
            ...
            ac_literals: &["<|im_", "<|endoftext", "<<SYS>>", "<</SYS>>", "[INST]", "[/INST]", "<system_prompt>", "</system_prompt>", "<system>", "<|system"],
            special: SpecialMatch::None,
        },
